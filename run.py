...
if __name__ == "__main__":
    ...
    input_paths = {
        "sample": f"input/2023/{args.day:02}_sample.txt",
        "input": f"{args.day:02}.txt",
    }
    ...
    for i in ("p1", "p2"):
        ...
        #print(f"--- {i} ---")
        #print("sample:", end="\t")
        #run(getattr(module, i), f"input/2023/day{args.day:02}_sample.txt")
        reload(module)
        #print(f"--- {i} ---","input:", end="\t")
        run(getattr(module, i), f"{args.day:02}.txt")
